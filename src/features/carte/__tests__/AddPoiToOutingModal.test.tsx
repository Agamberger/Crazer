...
import { AddPoiToOutingModal } from '../components/AddPoiToOutingModal';
...
describe('AddPoiToOutingModal', () => {
  ...
  test('ne rend rien si poi est null', () => {
  ...
  test('enregistre le lieu et crée l\'étape planifiée avec succès', async () => {
    ...
    await waitFor(() => {
      expect(ensurePlaceExists).toHaveBeenCalledWith(mockPoi, 'user-test-123');
